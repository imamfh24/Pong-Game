...
public class Trajectory : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        RaycastHit2D[] circleCastHit2DArray = Physics2D.CircleCastAll(ballRigidbody2D.position, ballCircleCollider2D.radius, ballRigidbody2D.velocity.normalized);
        ...
        foreach(RaycastHit2D circleCastHit2D in circleCastHit2DArray)
        {
            ...
            if(circleCastHit2D.collider != null && circleCastHit2D.collider.GetComponent<BallControl>() == null)
            {
                ...
                offsetHitPoint = hitPoint + hitNormal * ballCircleCollider2D.radius;
                ...
                if (circleCastHit2D.collider.GetComponent<GoalWall>() == null)
                {
